...
metacode-journal is a personal archive of:
...
AI-based interactive courtroom simulation platform  
where users participate in evidence analysis, discussion, and voting.
...
> Technology is not only functional.  
> It is also aesthetic, symbolic, and philosophical.

This journal explores the relationship between:
- code and perception
- systems and meaning
- interfaces and human experience
